...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.saurabhlande.bankingsystem.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.saurabhlande.bankingsystem.ViewHolder.ClickListener clickListener){

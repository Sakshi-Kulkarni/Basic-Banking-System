...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.saurabhlande.bankingsystem.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.saurabhlande.bankingsystem.HistoryList historyList, List<Model> modelList) {
